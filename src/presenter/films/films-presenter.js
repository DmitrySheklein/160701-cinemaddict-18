import { render, remove, RenderPosition } from 'src/framework/render';
import FilmsContainer from 'src/view/films-container-view';
...
import { StatusTitleMap } from 'src/main-const';
import FilmCardPresenter from 'src/presenter/film-card-presenter';
import { SortType, UserAction, UpdateType, NavigationType } from 'src/main-const';
import { sortFilmsDate, sortFilmsRating } from 'src/utils/sort';
import FilmPopupPresenter from 'src/presenter/film-popup-presenter';
